...
use diesel_async::{AsyncPgConnection, deadpool::{ConnectionManager, Pool}};
...
pub async fn sign(db: Data<Pool<ConnectionManager<AsyncPgConnection>>>, redis: Data<RedisPool>, body: Json<UnsignedBody>) -> actix_web::Result<HttpResponse, ValidatorServerError> {

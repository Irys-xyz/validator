...
use openssl::{sign, hash::MessageDigest, rsa::Padding, pkey::{PKey, Private}};
use redis::AsyncCommands;
use reool::{RedisPool, PoolDefault};
use serde::{Serialize, Deserialize};

use crate::{server::error::ValidatorServerError, types::DbPool, database::{models::NewTransaction, CassandraCtx}};
...
pub async fn sign(db: Data<CassandraCtx>, redis: Data<RedisPool>, body: Json<UnsignedBody>) -> actix_web::Result<HttpResponse, ValidatorServerError> {

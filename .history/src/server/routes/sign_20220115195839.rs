...
use diesel_async::{AsyncPgConnection, deadpool::ConnectionManager};
...
pub async fn sign(db: Data<bool<ConnectionManager<AsyncPgConnection>>>, redis: Data<RedisPool>, body: Json<UnsignedBody>) -> actix_web::Result<HttpResponse, ValidatorServerError> {
